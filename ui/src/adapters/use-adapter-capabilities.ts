...
const KNOWN_DEFAULTS: Record<string, AdapterCapabilities> = {
  ...
  "free-mesh": { supportsInstructionsBundle: false, supportsSkills: false, supportsLocalAgentJwt: false, requiresMaterializedRuntimeSkills: false, supportsModelProfiles: true },
